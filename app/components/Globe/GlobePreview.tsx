...
export function GlobePreview({ className }: { className?: string }) {
  const globeConfig = {
    pointSize: 4,
    globeColor: '#062056',
    showAtmosphere: true,
  ...
  const colors = ['#eaf320', '#ff0cf9', '#90ee0d'];
  const sampleArcs = [
    {
      order: 1,
      startLat: -19.885592,
  ...
  return (
    <div
      className={cn(
        'relative flex h-screen w-full flex-row items-center justify-center bg-white py-20 md:h-auto dark:bg-black',
        className
      )}
    >
